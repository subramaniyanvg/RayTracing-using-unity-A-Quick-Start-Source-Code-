...
{
	public virtual bool hit(ref Ray ray,ref float t,ref Shade s)
	{
		t = Mathf.Infinity;
		s = null;
		return false;
	...
	//Same as above but will be used for shadow calculation
	public virtual bool shadow_hit(ref Ray ray,ref float t)
	{
		t = Mathf.Infinity;
		return false;
	}
